...
#         data_root=data_root,
#         metainfo=dict(classes=classes),
#         ann_file='VisDrone2019/annotations/VisDrone2019-DET_test_coco.json',
#         data_prefix=dict(img='VisDrone2019/VisDrone2019-DET-test/images/'),
#         test_mode=True,
#         pipeline=test_pipeline))
...
# test_evaluator = dict(
#     type='CocoMetric',
#     ann_file=data_root + 'VisDrone2019/annotations/VisDrone2019-DET_test_coco.json',
#     metric='bbox',
#     classwise=True)
...
default_hooks = dict(
    ...
    draw_gt=False, # 是否画真值
    uavdt_test=False)### 用visdrone模型测试uavdt
    )
